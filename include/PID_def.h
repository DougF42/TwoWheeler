...
class PID_def
{
  ...
  //commonly used functions **************************************************************************
    PID_def(float*, float*, float*,        // * constructor.  links the PID_def to the Input, Output, and 
    ...
    void SetMode(int Mode);               // * sets PID_def to either Manual (0) or Auto (non-0)

    bool Compute();                       // * performs the PID_def calculation.  it should be
