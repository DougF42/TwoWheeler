...
static const uint8_t powers_ten_e[84] = {
    ...
    12,  15,  19,  22,  25,  29,  32,  35,  39,  42,  45,  49,  52,  55,
    59,  62,  65,  69,  72,  75,  79,  82,  85,  89,  92,  95,  98,  102,
    105, 108, 112, 115, 118, 122, 125, 128, 132, 135, 138, 142, 145, 148,
};
...
uint32_t ftoa(char *str, size_t size, float f, int32_t precision) {
  ...
  int32_t idx = 37 - mk;
  if ((idx < 0) ||
      (idx >= (int32_t)(sizeof(powers_ten) / sizeof(powers_ten[0])))) {
